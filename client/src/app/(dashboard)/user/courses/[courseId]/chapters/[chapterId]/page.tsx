					...
					<Card className="course__instructor-card">
						<CardContent className="course__instructor-info">
							...
							<div className="course__instructor-bio">
								<p>
									A seasoned System Engineer with over 15 years of experience in
									creating intuitive and engaging digital experiences. Expertise
									in leading technologies and delivering cutting-edge solutions.
								</p>
							</div>
						</CardContent>
					</Card>
